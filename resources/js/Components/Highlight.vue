<template>
    <div>
        ...
        <div class="fixed z-50 flex items-center justify-center lightbox pin" v-if="visible" @click="hide">
            <div class="fixed p-1 mr-2 text-4xl text-white cursor-pointer pin-r pin-t" @click.stop="hide">&times;</div>
            <div class="flex">
                <div class="self-center px-8 cursor-pointer"
                    @click.stop="prev"
